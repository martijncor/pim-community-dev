...
class ProductNormalizerSpec extends ObjectBehavior
{
    ...
    function it_normalizes_variant_product(
        ...
        $sku->isLocalized()->willReturn(false);
        $sku->isScoped()->willReturn(false);
    ...
    function it_normalizes_product_with_a_multiselect_value(
        ...
        $colors->isLocalized()->willReturn(false);
        $colors->isScoped()->willReturn(false);
    ...
    function it_normalizes_product_with_price(
        ...
        $price->isLocalized()->willReturn(false);
        $price->isScoped()->willReturn(false);
