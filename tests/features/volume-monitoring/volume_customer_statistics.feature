Feature: Volume statistics of the customers
  ...
  Scenario: Gather customers statistics about the average size of the products
    The potential size of the products is defined by the average number of product values that it could imply
  ...
  @acceptance-back
  Scenario: Gather customers statistics about the potential size of the products
  ...
  @acceptance-back
  Scenario: Gather customers statistics about the potential size of attributes per family
    The potential size of attributes per family is defined by the average number of product values per family that it could imply
    Given a channel defined with 2 activated locales
